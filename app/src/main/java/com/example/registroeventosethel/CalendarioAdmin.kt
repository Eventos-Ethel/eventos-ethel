...
class CalendarioAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnFiltradoCliente.setOnClickListener {
            startActivity(Intent(this, CalendarioFiltradoClienteAdmin::class.java))
        }

        btnFiltradoFecha.setOnClickListener {
            startActivity(Intent(this, CalendarioFiltradoFechaAdmin::class.java))
        }
